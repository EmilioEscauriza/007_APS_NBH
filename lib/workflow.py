...
# Use run_workflow.py to run. Config in workflow_config.py.
...
from workflow_config import (
    ...
    FILE_ID, H5_FILE, H5_BASE_DIR, POSITION_NAME, OUT_DIR,
...
def mask_roi_viewer_mp4_save(
    *,
    ...
    export_path = f"../figures_export/movies/{pos}/{scan}/{pos}_{scan}_crop{crop_size}_stride{stride}.mp4"
